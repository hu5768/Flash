                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      mypageController.userModel.reach
                                          .toString(),
                                      style: TextStyle(color: Colors.white),
                                    ),
                                  ],
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                              ...
                              child: SliderTheme(
                                ...
                                child: SizedBox(
                                  ...
                                  child: Slider(
                                    ...
                                    value: firstAnswerController
                                        .videoController!
                                        .value
                                        .position
                                        .inSeconds
                                        .toDouble(),
                                    max: firstAnswerController.videoController!
                            ...
                            Text(
                              '${firstAnswerController.videoController!.value.position.inMinutes.toString().padLeft(2, '0')}:${firstAnswerController.videoController!.value.position.inSeconds.toString().padLeft(2, '0')}',
                              style: TextStyle(color: Colors.white),
                            ),
                          ],
                        ),
